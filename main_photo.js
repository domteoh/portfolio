...
span.onclick = function() {
  ...
  function div1() {
    ...
    document.getElementById("image-13").style.display = "none";
    document.getElementById("image-14").style.display = "none";
    document.getElementById("image-15").style.display = "none";
  }
  ...
  function div13() {
    document.getElementById("image-13").style.display = "block";
    document.getElementById("image-2").style.display = "none";
    document.getElementById("image-3").style.display = "none";
    document.getElementById("image-4").style.display = "none";
    document.getElementById("image-5").style.display = "none";
  ...
  function div14() {
    document.getElementById("image-14").style.display = "block";
    document.getElementById("image-2").style.display = "none";
    document.getElementById("image-3").style.display = "none";
    document.getElementById("image-4").style.display = "none";
    document.getElementById("image-5").style.display = "none";
  ...
  function div15() {
    document.getElementById("image-15").style.display = "block";
    document.getElementById("image-2").style.display = "none";
    document.getElementById("image-3").style.display = "none";
    document.getElementById("image-4").style.display = "none";
    document.getElementById("image-5").style.display = "none";
